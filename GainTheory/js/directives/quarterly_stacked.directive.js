var quartelyStacked = function($compile) {
    function link(scope, ele, attr) {
        ...
        scope.value.drawMap = function(quarter, product) {
            ...
            console.log('quarter, product :: ', quarter + ' ' + product);
            scope.chartObj.products.push(product);
    ...
    return {
        ...
        // template: '<div id=\'quartely-stack-group-chart\'/>',
        replace: true
    };
};
