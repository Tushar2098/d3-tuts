var nationBubbleChart = function($compile) {
    ...
    function link(scope, ele, attr) {
        ...
        var first_time = true;
        // Load the data.
        d3.json("./json/nations.json", function(nations) {
    ...
    return {
        ...
        restrict: 'EA',
        scope: {},
        templateUrl:'./templates/nationbubblechart.tmpl.html',
        replace: true
    };
};

angular.module('GainTheory')
    .directive('nationBubbleChart', nationBubbleChart);
